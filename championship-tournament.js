    ...
    REGIONAL_CHAMPIONS: [
        ...
        },
        {
            ...
            team: [
                ...
                { speciesId: 'beautifly', level: 78, moves: ['silverwind', 'gigadrain', 'psychic', 'morningsun'] },
                { speciesId: 'skitty', level: 82, moves: ['blizzard', 'doubleedge', 'thunderbolt', 'assist'] },
                { speciesId: 'bulbasaur', level: 85, moves: ['solarbeam', 'sludgebomb', 'leechseed', 'sleeppowder'] },
                { speciesId: 'munchlax', level: 80, moves: ['bodyslam', 'earthquake', 'focuspunch', 'shadowball'] },
                { speciesId: 'squirtle', level: 82, moves: ['hydropump', 'icebeam', 'bite', 'protect'] }
            ]
        },
        {
            name: "Brendan",
