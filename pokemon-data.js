...
const POKEMON_DATA = {
    ...
    gyarados: { ability: "intimidate", baseStats: { hp: 95, atk: 125, def: 79, spd: 81 }, spa: 15, spd_def: 20, evolves: null },
    ...
    alakazam: { ability: "clearbody", baseStats: { hp: 55, atk: 50, def: 45, spd: 120 }, spa: 135, spd_def: 95 },
    ...
    gengar: { ability: "levitate", baseStats: { hp: 60, atk: 65, def: 60, spd: 110 }, spa: 130, spd_def: 75, type2: 'Poison' },
    ...
    golem: { ability: "sturdy", baseStats: { hp: 80, atk: 120, def: 130, spd: 45 }, spa: 55, spd_def: 65, type2: 'Ground' },
    ...
    kingdra: { ability: "swiftswim", baseStats: { hp: 75, atk: 95, def: 95, spd: 85 }, spa: 95, spd_def: 95, type2: 'Dragon' },
    ...
    machamp: { ability: "guts", baseStats: { hp: 90, atk: 130, def: 80, spd: 55 }, spa: 65, spd_def: 85 },
    ...
    // ============================================
    // GEN 4-5 POKEMON (387-649)
    // ============================================
    turtwig: { ability: "overgrow", name: "Turtwig", type: "Grass", baseStats: { hp: 55, atk: 68, def: 64, spd: 31, evolves: { level: 18, into: 'grotle' } }, spa: 45, spd_def: 55, evolves: { level: 18, into: "grotle" } },
    grotle: { ability: "overgrow", name: "Grotle", type: "Grass", baseStats: { hp: 75, atk: 89, def: 85, spd: 36, evolves: { level: 32, into: 'torterra' } }, spa: 55, spd_def: 65, evolves: { level: 32, into: "torterra" } },
    torterra: { ability: "overgrow", name: "Torterra", type: "Grass", type2: "Ground", baseStats: { hp: 95, atk: 109, def: 105, spd: 56 }, spa: 75, spd_def: 85, evolves: null },
    chimchar: { ability: "blaze", name: "Chimchar", type: "Fire", baseStats: { hp: 44, atk: 58, def: 44, spd: 61, evolves: { level: 14, into: 'monferno' } }, spa: 58, spd_def: 44, evolves: { level: 14, into: "monferno" } },
    monferno: { ability: "blaze", name: "Monferno", type: "Fire", type2: "Fighting", baseStats: { hp: 64, atk: 78, def: 52, spd: 81, evolves: { level: 36, into: 'infernape' } }, spa: 78, spd_def: 52, evolves: { level: 36, into: "infernape" } },
    infernape: { ability: "blaze", name: "Infernape", type: "Fire", type2: "Fighting", baseStats: { hp: 76, atk: 104, def: 71, spd: 108 }, spa: 104, spd_def: 71, evolves: null },
    piplup: { ability: "torrent", name: "Piplup", type: "Water", baseStats: { hp: 53, atk: 51, def: 53, spd: 40, evolves: { level: 16, into: 'prinplup' } }, spa: 61, spd_def: 56, evolves: { level: 16, into: "prinplup" } },
    prinplup: { ability: "torrent", name: "Prinplup", type: "Water", baseStats: { hp: 64, atk: 66, def: 68, spd: 50, evolves: { level: 36, into: 'empoleon' } }, spa: 81, spd_def: 76, evolves: { level: 36, into: "empoleon" } },
    empoleon: { ability: "torrent", name: "Empoleon", type: "Water", type2: "Steel", baseStats: { hp: 84, atk: 86, def: 88, spd: 60 }, spa: 111, spd_def: 101, evolves: null },
    starly: { ability: "keen_eye", name: "Starly", type: "Normal", type2: "Flying", baseStats: { hp: 40, atk: 55, def: 30, spd: 60, evolves: { level: 14, into: 'staravia' } }, spa: 30, spd_def: 30, evolves: { level: 14, into: "staravia" } },
    staravia: { ability: "intimidate", name: "Staravia", type: "Normal", type2: "Flying", baseStats: { hp: 55, atk: 75, def: 50, spd: 80, evolves: { level: 34, into: 'staraptor' } }, spa: 40, spd_def: 40, evolves: { level: 34, into: "staraptor" } },
    staraptor: { ability: "intimidate", name: "Staraptor", type: "Normal", type2: "Flying", baseStats: { hp: 85, atk: 120, def: 70, spd: 100 }, spa: 50, spd_def: 60, evolves: null },
    staraptormega: { ability: "intimidate", name: "Staraptor-mega", type: "Fighting", type2: "Flying", baseStats: { hp: 85, atk: 140, def: 100, spd: 110 }, spa: 60, spd_def: 90, evolves: null },
    bidoof: { ability: "simple", name: "Bidoof", type: "Normal", baseStats: { hp: 59, atk: 45, def: 40, spd: 31, evolves: { level: 15, into: 'bibarel' } }, spa: 35, spd_def: 40, evolves: { level: 15, into: "bibarel" } },
    bibarel: { ability: "simple", name: "Bibarel", type: "Normal", type2: "Water", baseStats: { hp: 79, atk: 85, def: 60, spd: 71 }, spa: 55, spd_def: 60, evolves: null },
    kricketot: { ability: "shed_skin", name: "Kricketot", type: "Bug", baseStats: { hp: 37, atk: 25, def: 41, spd: 25, evolves: { level: 10, into: 'kricketune' } }, spa: 25, spd_def: 41, evolves: { level: 10, into: "kricketune" } },
    kricketune: { ability: "swarm", name: "Kricketune", type: "Bug", baseStats: { hp: 77, atk: 85, def: 51, spd: 65 }, spa: 55, spd_def: 51, evolves: null },
    shinx: { ability: "rivalry", name: "Shinx", type: "Electric", baseStats: { hp: 45, atk: 65, def: 34, spd: 45, evolves: { level: 15, into: 'luxio' } }, spa: 40, spd_def: 34, evolves: { level: 15, into: "luxio" } },
    luxio: { ability: "rivalry", name: "Luxio", type: "Electric", baseStats: { hp: 60, atk: 85, def: 49, spd: 60, evolves: { level: 30, into: 'luxray' } }, spa: 60, spd_def: 49, evolves: { level: 30, into: "luxray" } },
    luxray: { ability: "rivalry", name: "Luxray", type: "Electric", baseStats: { hp: 80, atk: 120, def: 79, spd: 70 }, spa: 95, spd_def: 79, evolves: null },
    budew: { ability: "natural_cure", name: "Budew", type: "Grass", type2: "Poison", baseStats: { hp: 40, atk: 30, def: 35, spd: 55, evolves: { level: 20, into: 'roselia' } }, spa: 50, spd_def: 70, evolves: { level: 16, into: "roselia" } },
    roserade: { ability: "natural_cure", name: "Roserade", type: "Grass", type2: "Poison", baseStats: { hp: 60, atk: 70, def: 65, spd: 90 }, spa: 125, spd_def: 105, evolves: null },
    cranidos: { ability: "mold_breaker", name: "Cranidos", type: "Rock", baseStats: { hp: 67, atk: 125, def: 40, spd: 58, evolves: { level: 30, into: 'rampardos' } }, spa: 30, spd_def: 30, evolves: { level: 30, into: "rampardos" } },
    rampardos: { ability: "mold_breaker", name: "Rampardos", type: "Rock", baseStats: { hp: 97, atk: 165, def: 60, spd: 58 }, spa: 65, spd_def: 50, evolves: null },
    shieldon: { ability: "sturdy", name: "Shieldon", type: "Rock", type2: "Steel", baseStats: { hp: 30, atk: 42, def: 118, spd: 30, evolves: { level: 30, into: 'bastiodon' } }, spa: 42, spd_def: 88, evolves: { level: 30, into: "bastiodon" } },
    bastiodon: { ability: "sturdy", name: "Bastiodon", type: "Rock", type2: "Steel", baseStats: { hp: 60, atk: 52, def: 168, spd: 30 }, spa: 47, spd_def: 138, evolves: null },
    burmy: { ability: "shed_skin", name: "Burmy", type: "Bug", baseStats: { hp: 40, atk: 29, def: 45, spd: 36, evolves: { level: 20, into: 'wormadam' } }, spa: 29, spd_def: 45, evolves: { level: 20, into: "wormadam" } },
    burmysandy: { ability: "shed_skin", name: "Burmy", type: "Bug", baseStats: { hp: 40, atk: 29, def: 45, spd: 36, evolves: { level: 20, into: 'wormadam' } }, spa: 29, spd_def: 45, evolves: { level: 20, into: "wormadam" } },
    burmytrash: { ability: "shed_skin", name: "Burmy", type: "Bug", baseStats: { hp: 40, atk: 29, def: 45, spd: 36, evolves: { level: 20, into: 'wormadam' } }, spa: 29, spd_def: 45, evolves: { level: 20, into: "wormadam" } },
    wormadam: { ability: "anticipation", name: "Wormadam", type: "Bug", type2: "Grass", baseStats: { hp: 60, atk: 59, def: 85, spd: 36 }, spa: 79, spd_def: 105, evolves: null },
    wormadamsandy: { ability: "anticipation", name: "Wormadam-sandy", type: "Bug", type2: "Ground", baseStats: { hp: 60, atk: 79, def: 105, spd: 36 }, spa: 59, spd_def: 85, evolves: null },
    wormadamtrash: { ability: "anticipation", name: "Wormadam-trash", type: "Bug", type2: "Steel", baseStats: { hp: 60, atk: 69, def: 95, spd: 36 }, spa: 69, spd_def: 95, evolves: null },
    mothim: { ability: "swarm", name: "Mothim", type: "Bug", type2: "Flying", baseStats: { hp: 70, atk: 94, def: 50, spd: 66 }, spa: 94, spd_def: 50, evolves: null },
    combee: { ability: "honey_gather", name: "Combee", type: "Bug", type2: "Flying", baseStats: { hp: 30, atk: 30, def: 42, spd: 70, evolves: { level: 21, into: 'vespiquen' } }, spa: 30, spd_def: 42, evolves: { level: 21, into: "vespiquen" } },
    vespiquen: { ability: "pressure", name: "Vespiquen", type: "Bug", type2: "Flying", baseStats: { hp: 70, atk: 80, def: 102, spd: 40 }, spa: 80, spd_def: 102, evolves: null },
    pachirisu: { ability: "run_away", name: "Pachirisu", type: "Electric", baseStats: { hp: 60, atk: 45, def: 70, spd: 95 }, spa: 45, spd_def: 90, evolves: null },
    buizel: { ability: "swift_swim", name: "Buizel", type: "Water", baseStats: { hp: 55, atk: 65, def: 35, spd: 85, evolves: { level: 26, into: 'floatzel' } }, spa: 60, spd_def: 30, evolves: { level: 26, into: "floatzel" } },
    floatzel: { ability: "swift_swim", name: "Floatzel", type: "Water", baseStats: { hp: 85, atk: 105, def: 55, spd: 115 }, spa: 85, spd_def: 50, evolves: null },
    cherubi: { ability: "chlorophyll", name: "Cherubi", type: "Grass", baseStats: { hp: 45, atk: 35, def: 45, spd: 35, evolves: { level: 25, into: 'cherrim' } }, spa: 62, spd_def: 53, evolves: { level: 25, into: "cherrim" } },
    cherrim: { ability: "flower_gift", name: "Cherrim", type: "Grass", baseStats: { hp: 70, atk: 60, def: 70, spd: 85 }, spa: 87, spd_def: 78, evolves: null },
    cherrimsunshine: { ability: "flower_gift", name: "Cherrim-sunshine", type: "Grass", baseStats: { hp: 70, atk: 60, def: 70, spd: 85 }, spa: 87, spd_def: 78, evolves: null },
    shellos: { ability: "sticky_hold", name: "Shellos", type: "Water", baseStats: { hp: 76, atk: 48, def: 48, spd: 34, evolves: { level: 30, into: 'gastrodon' } }, spa: 57, spd_def: 62, evolves: { level: 30, into: "gastrodon" } },
    shelloseast: { ability: "sticky_hold", name: "Shellos", type: "Water", baseStats: { hp: 76, atk: 48, def: 48, spd: 34, evolves: { level: 30, into: 'gastrodon' } }, spa: 57, spd_def: 62, evolves: { level: 30, into: "gastrodon" } },
    gastrodon: { ability: "sticky_hold", name: "Gastrodon", type: "Water", type2: "Ground", baseStats: { hp: 111, atk: 83, def: 68, spd: 39 }, spa: 92, spd_def: 82, evolves: null },
    gastrodoneast: { ability: "sticky_hold", name: "Gastrodon", type: "Water", type2: "Ground", baseStats: { hp: 111, atk: 83, def: 68, spd: 39 }, spa: 92, spd_def: 82, evolves: null },
    ambipom: { ability: "technician", name: "Ambipom", type: "Normal", baseStats: { hp: 75, atk: 100, def: 66, spd: 115 }, spa: 60, spd_def: 66, evolves: null },
    drifloon: { ability: "aftermath", name: "Drifloon", type: "Ghost", type2: "Flying", baseStats: { hp: 90, atk: 50, def: 34, spd: 70, evolves: { level: 28, into: 'drifblim' } }, spa: 60, spd_def: 44, evolves: { level: 28, into: "drifblim" } },
    drifblim: { ability: "aftermath", name: "Drifblim", type: "Ghost", type2: "Flying", baseStats: { hp: 150, atk: 80, def: 44, spd: 80 }, spa: 90, spd_def: 54, evolves: null },
    buneary: { ability: "run_away", name: "Buneary", type: "Normal", baseStats: { hp: 55, atk: 66, def: 44, spd: 85, evolves: { level: 20, into: 'lopunny' } }, spa: 44, spd_def: 56, evolves: { level: 16, into: "lopunny" } },
    lopunny: { ability: "cute_charm", name: "Lopunny", type: "Normal", baseStats: { hp: 65, atk: 76, def: 84, spd: 105 }, spa: 54, spd_def: 96, evolves: null },
    lopunnymega: { ability: "scrappy", name: "Lopunny-mega", type: "Normal", type2: "Fighting", baseStats: { hp: 65, atk: 136, def: 94, spd: 135 }, spa: 54, spd_def: 96, evolves: null },
    mismagius: { ability: "levitate", name: "Mismagius", type: "Ghost", baseStats: { hp: 60, atk: 60, def: 60, spd: 105 }, spa: 105, spd_def: 105, evolves: null },
    honchkrow: { ability: "insomnia", name: "Honchkrow", type: "Dark", type2: "Flying", baseStats: { hp: 100, atk: 125, def: 52, spd: 71 }, spa: 105, spd_def: 52, evolves: null },
    glameow: { ability: "limber", name: "Glameow", type: "Normal", baseStats: { hp: 49, atk: 55, def: 42, spd: 85, evolves: { level: 38, into: 'purugly' } }, spa: 42, spd_def: 37, evolves: { level: 38, into: "purugly" } },
    purugly: { ability: "thick_fat", name: "Purugly", type: "Normal", baseStats: { hp: 71, atk: 82, def: 64, spd: 112 }, spa: 64, spd_def: 59, evolves: null },
    chingling: { ability: "levitate", name: "Chingling", type: "Psychic", baseStats: { hp: 45, atk: 30, def: 50, spd: 45, evolves: { level: 20, into: 'chimecho' } }, spa: 65, spd_def: 50, evolves: { level: 16, into: "chimecho" } },
    stunky: { ability: "stench", name: "Stunky", type: "Poison", type2: "Dark", baseStats: { hp: 63, atk: 63, def: 47, spd: 74, evolves: { level: 34, into: 'skuntank' } }, spa: 41, spd_def: 41, evolves: { level: 34, into: "skuntank" } },
    skuntank: { ability: "stench", name: "Skuntank", type: "Poison", type2: "Dark", baseStats: { hp: 103, atk: 93, def: 67, spd: 84 }, spa: 71, spd_def: 61, evolves: null },
    bronzor: { ability: "levitate", name: "Bronzor", type: "Steel", type2: "Psychic", baseStats: { hp: 57, atk: 24, def: 86, spd: 23, evolves: { level: 33, into: 'bronzong' } }, spa: 24, spd_def: 86, evolves: { level: 33, into: "bronzong" } },
    bronzong: { ability: "levitate", name: "Bronzong", type: "Steel", type2: "Psychic", baseStats: { hp: 67, atk: 89, def: 116, spd: 33 }, spa: 79, spd_def: 116, evolves: null },
    bonsly: { ability: "sturdy", name: "Bonsly", type: "Rock", baseStats: { hp: 50, atk: 80, def: 95, spd: 10, evolves: { level: 25, into: 'sudowoodo' } }, spa: 10, spd_def: 45, evolves: { level: 16, into: "sudowoodo" } },
    mimejr: { ability: "soundproof", name: "Mime jr.", type: "Psychic", type2: "Fairy", baseStats: { hp: 20, atk: 25, def: 45, spd: 60 }, spa: 70, spd_def: 90, evolves: { level: 16, into: "mrmime" } },
    happiny: { ability: "natural_cure", name: "Happiny", type: "Normal", baseStats: { hp: 100, atk: 5, def: 5, spd: 30, evolves: { item: 'ovalstone', into: 'chansey' } }, spa: 15, spd_def: 65, evolves: { level: 16, into: "chansey" } },
    chatot: { ability: "keen_eye", name: "Chatot", type: "Normal", type2: "Flying", baseStats: { hp: 76, atk: 65, def: 45, spd: 91 }, spa: 92, spd_def: 42, evolves: null },
    spiritomb: { ability: "pressure", name: "Spiritomb", type: "Ghost", type2: "Dark", baseStats: { hp: 50, atk: 92, def: 108, spd: 35 }, spa: 92, spd_def: 108, evolves: null },
    gible: { ability: "sand_veil", name: "Gible", type: "Dragon", type2: "Ground", baseStats: { hp: 58, atk: 70, def: 45, spd: 42, evolves: { level: 24, into: 'gabite' } }, spa: 40, spd_def: 45, evolves: { level: 24, into: "gabite" } },
    gabite: { ability: "sand_veil", name: "Gabite", type: "Dragon", type2: "Ground", baseStats: { hp: 68, atk: 90, def: 65, spd: 82, evolves: { level: 48, into: 'garchomp' } }, spa: 50, spd_def: 55, evolves: { level: 48, into: "garchomp" } },
    garchomp: { ability: "sand_veil", name: "Garchomp", type: "Dragon", type2: "Ground", baseStats: { hp: 108, atk: 130, def: 95, spd: 102 }, spa: 80, spd_def: 85, evolves: null },
    garchompmega: { ability: "sand_force", name: "Garchomp-mega", type: "Dragon", type2: "Ground", baseStats: { hp: 108, atk: 170, def: 115, spd: 92 }, spa: 120, spd_def: 95, evolves: null },
    garchompmegaz: { ability: "sand_force", name: "Garchomp-mega-z", type: "Dragon", baseStats: { hp: 108, atk: 130, def: 85, spd: 151 }, spa: 141, spd_def: 85, evolves: null },
    munchlax: { ability: "pickup", name: "Munchlax", type: "Normal", baseStats: { hp: 135, atk: 85, def: 40, spd: 5, evolves: { level: 20, into: 'snorlax' } }, spa: 40, spd_def: 85, evolves: { level: 16, into: "snorlax" } },
    riolu: { ability: "steadfast", name: "Riolu", type: "Fighting", baseStats: { hp: 40, atk: 70, def: 40, spd: 60, evolves: { level: 20, into: 'lucario' } }, spa: 35, spd_def: 40, evolves: { level: 16, into: "lucario" } },
    lucario: { ability: "steadfast", name: "Lucario", type: "Fighting", type2: "Steel", baseStats: { hp: 70, atk: 110, def: 70, spd: 90 }, spa: 115, spd_def: 70, evolves: null },
    lucariomega: { ability: "adaptability", name: "Lucario-mega", type: "Fighting", type2: "Steel", baseStats: { hp: 70, atk: 145, def: 88, spd: 112 }, spa: 140, spd_def: 70, evolves: null },
    lucariomegaz: { ability: "adaptability", name: "Lucario-mega-z", type: "Fighting", type2: "Steel", baseStats: { hp: 70, atk: 100, def: 70, spd: 151 }, spa: 164, spd_def: 70, evolves: null },
    hippopotas: { ability: "sand_stream", name: "Hippopotas", type: "Ground", baseStats: { hp: 68, atk: 72, def: 78, spd: 32, evolves: { level: 34, into: 'hippowdon' } }, spa: 38, spd_def: 42, evolves: { level: 34, into: "hippowdon" } },
    hippowdon: { ability: "sand_stream", name: "Hippowdon", type: "Ground", baseStats: { hp: 108, atk: 112, def: 118, spd: 47 }, spa: 68, spd_def: 72, evolves: null },
    skorupi: { ability: "battle_armor", name: "Skorupi", type: "Poison", type2: "Bug", baseStats: { hp: 40, atk: 50, def: 90, spd: 65, evolves: { level: 40, into: 'drapion' } }, spa: 30, spd_def: 55, evolves: { level: 40, into: "drapion" } },
    drapion: { ability: "battle_armor", name: "Drapion", type: "Poison", type2: "Dark", baseStats: { hp: 70, atk: 90, def: 110, spd: 95 }, spa: 60, spd_def: 75, evolves: null },
    croagunk: { ability: "anticipation", name: "Croagunk", type: "Poison", type2: "Fighting", baseStats: { hp: 48, atk: 61, def: 40, spd: 50, evolves: { level: 37, into: 'toxicroak' } }, spa: 61, spd_def: 40, evolves: { level: 37, into: "toxicroak" } },
    toxicroak: { ability: "anticipation", name: "Toxicroak", type: "Poison", type2: "Fighting", baseStats: { hp: 83, atk: 106, def: 65, spd: 85 }, spa: 86, spd_def: 65, evolves: null },
    carnivine: { ability: "levitate", name: "Carnivine", type: "Grass", baseStats: { hp: 74, atk: 100, def: 72, spd: 46 }, spa: 90, spd_def: 72, evolves: null },
    finneon: { ability: "swift_swim", name: "Finneon", type: "Water", baseStats: { hp: 49, atk: 49, def: 56, spd: 66, evolves: { level: 31, into: 'lumineon' } }, spa: 49, spd_def: 61, evolves: { level: 31, into: "lumineon" } },
    lumineon: { ability: "swift_swim", name: "Lumineon", type: "Water", baseStats: { hp: 69, atk: 69, def: 76, spd: 91 }, spa: 69, spd_def: 86, evolves: null },
    mantyke: { ability: "swift_swim", name: "Mantyke", type: "Water", type2: "Flying", baseStats: { hp: 45, atk: 20, def: 50, spd: 50, evolves: { level: 25, into: 'mantine' } }, spa: 60, spd_def: 120, evolves: { level: 16, into: "mantine" } },
    snover: { ability: "snow_warning", name: "Snover", type: "Grass", type2: "Ice", baseStats: { hp: 60, atk: 62, def: 50, spd: 40, evolves: { level: 40, into: 'abomasnow' } }, spa: 62, spd_def: 60, evolves: { level: 40, into: "abomasnow" } },
    abomasnow: { ability: "snow_warning", name: "Abomasnow", type: "Grass", type2: "Ice", baseStats: { hp: 90, atk: 92, def: 75, spd: 60 }, spa: 92, spd_def: 85, evolves: null },
    abomasnowmega: { ability: "snow_warning", name: "Abomasnow-mega", type: "Grass", type2: "Ice", baseStats: { hp: 90, atk: 132, def: 105, spd: 30 }, spa: 132, spd_def: 105, evolves: null },
    weavile: { ability: "pressure", name: "Weavile", type: "Dark", type2: "Ice", baseStats: { hp: 70, atk: 120, def: 65, spd: 125 }, spa: 45, spd_def: 85, evolves: null },
    magnezone: { ability: "magnet_pull", name: "Magnezone", type: "Electric", type2: "Steel", baseStats: { hp: 70, atk: 70, def: 115, spd: 60 }, spa: 130, spd_def: 90, evolves: null },
    lickilicky: { ability: "own_tempo", name: "Lickilicky", type: "Normal", baseStats: { hp: 110, atk: 85, def: 95, spd: 50 }, spa: 80, spd_def: 95, evolves: null },
    rhyperior: { ability: "lightning_rod", name: "Rhyperior", type: "Ground", type2: "Rock", baseStats: { hp: 115, atk: 140, def: 130, spd: 40 }, spa: 55, spd_def: 55, evolves: null },
    tangrowth: { ability: "chlorophyll", name: "Tangrowth", type: "Grass", baseStats: { hp: 100, atk: 100, def: 125, spd: 50 }, spa: 110, spd_def: 50, evolves: null },
    electivire: { ability: "motor_drive", name: "Electivire", type: "Electric", baseStats: { hp: 75, atk: 123, def: 67, spd: 95 }, spa: 95, spd_def: 85, evolves: null },
    magmortar: { ability: "flame_body", name: "Magmortar", type: "Fire", baseStats: { hp: 75, atk: 95, def: 67, spd: 83 }, spa: 125, spd_def: 95, evolves: null },
    togekiss: { ability: "hustle", name: "Togekiss", type: "Fairy", type2: "Flying", baseStats: { hp: 85, atk: 50, def: 95, spd: 80 }, spa: 120, spd_def: 115, evolves: null },
    yanmega: { ability: "speed_boost", name: "Yanmega", type: "Bug", type2: "Flying", baseStats: { hp: 86, atk: 76, def: 86, spd: 95 }, spa: 116, spd_def: 56, evolves: null },
    leafeon: { ability: "leaf_guard", name: "Leafeon", type: "Grass", baseStats: { hp: 65, atk: 110, def: 130, spd: 95 }, spa: 60, spd_def: 65, evolves: null },
    glaceon: { ability: "snow_cloak", name: "Glaceon", type: "Ice", baseStats: { hp: 65, atk: 60, def: 110, spd: 65 }, spa: 130, spd_def: 95, evolves: null },
    gliscor: { ability: "hyper_cutter", name: "Gliscor", type: "Ground", type2: "Flying", baseStats: { hp: 75, atk: 95, def: 125, spd: 95 }, spa: 45, spd_def: 75, evolves: null },
    mamoswine: { ability: "oblivious", name: "Mamoswine", type: "Ice", type2: "Ground", baseStats: { hp: 110, atk: 130, def: 80, spd: 80 }, spa: 70, spd_def: 60, evolves: null },
    porygonz: { ability: "adaptability", name: "Porygon-z", type: "Normal", baseStats: { hp: 85, atk: 80, def: 70, spd: 90 }, spa: 135, spd_def: 75, evolves: null },
    gallade: { ability: "steadfast", name: "Gallade", type: "Psychic", type2: "Fighting", baseStats: { hp: 68, atk: 125, def: 65, spd: 80 }, spa: 65, spd_def: 115, evolves: null },
    gallademega: { ability: "inner_focus", name: "Gallade-mega", type: "Psychic", type2: "Fighting", baseStats: { hp: 68, atk: 165, def: 95, spd: 110 }, spa: 65, spd_def: 115, evolves: null },
    probopass: { ability: "sturdy", name: "Probopass", type: "Rock", type2: "Steel", baseStats: { hp: 60, atk: 55, def: 145, spd: 40 }, spa: 75, spd_def: 150, evolves: null },
    dusknoir: { ability: "pressure", name: "Dusknoir", type: "Ghost", baseStats: { hp: 45, atk: 100, def: 135, spd: 45 }, spa: 65, spd_def: 135, evolves: null },
    froslass: { ability: "snow_cloak", name: "Froslass", type: "Ice", type2: "Ghost", baseStats: { hp: 70, atk: 80, def: 70, spd: 110 }, spa: 80, spd_def: 70, evolves: null },
    froslassmega: { ability: "snow_cloak", name: "Froslass-mega", type: "Ice", type2: "Ghost", baseStats: { hp: 70, atk: 80, def: 70, spd: 120 }, spa: 140, spd_def: 100, evolves: null },
    rotom: { ability: "levitate", name: "Rotom", type: "Electric", type2: "Ghost", baseStats: { hp: 50, atk: 50, def: 77, spd: 91 }, spa: 95, spd_def: 77, evolves: null },
    rotomheat: { ability: "levitate", name: "Rotom-heat", type: "Electric", type2: "Fire", baseStats: { hp: 50, atk: 65, def: 107, spd: 86 }, spa: 105, spd_def: 107, evolves: null },
    rotomwash: { ability: "levitate", name: "Rotom-wash", type: "Electric", type2: "Water", baseStats: { hp: 50, atk: 65, def: 107, spd: 86 }, spa: 105, spd_def: 107, evolves: null },
    rotomfrost: { ability: "levitate", name: "Rotom-frost", type: "Electric", type2: "Ice", baseStats: { hp: 50, atk: 65, def: 107, spd: 86 }, spa: 105, spd_def: 107, evolves: null },
    rotomfan: { ability: "levitate", name: "Rotom-fan", type: "Electric", type2: "Flying", baseStats: { hp: 50, atk: 65, def: 107, spd: 86 }, spa: 105, spd_def: 107, evolves: null },
    rotommow: { ability: "levitate", name: "Rotom-mow", type: "Electric", type2: "Grass", baseStats: { hp: 50, atk: 65, def: 107, spd: 86 }, spa: 105, spd_def: 107, evolves: null },
    uxie: { ability: "levitate", name: "Uxie", type: "Psychic", baseStats: { hp: 75, atk: 75, def: 130, spd: 95 }, spa: 75, spd_def: 130, evolves: null },
    mesprit: { ability: "levitate", name: "Mesprit", type: "Psychic", baseStats: { hp: 80, atk: 105, def: 105, spd: 80 }, spa: 105, spd_def: 105, evolves: null },
    azelf: { ability: "levitate", name: "Azelf", type: "Psychic", baseStats: { hp: 75, atk: 125, def: 70, spd: 115 }, spa: 125, spd_def: 70, evolves: null },
    dialga: { ability: "pressure", name: "Dialga", type: "Steel", type2: "Dragon", baseStats: { hp: 100, atk: 120, def: 120, spd: 90 }, spa: 150, spd_def: 100, evolves: null },
    dialgaorigin: { ability: "pressure", name: "Dialga-origin", type: "Steel", type2: "Dragon", baseStats: { hp: 100, atk: 100, def: 120, spd: 90 }, spa: 150, spd_def: 120, evolves: null },
    palkia: { ability: "pressure", name: "Palkia", type: "Water", type2: "Dragon", baseStats: { hp: 90, atk: 120, def: 100, spd: 100 }, spa: 150, spd_def: 120, evolves: null },
    palkiaorigin: { ability: "pressure", name: "Palkia-origin", type: "Water", type2: "Dragon", baseStats: { hp: 90, atk: 100, def: 100, spd: 120 }, spa: 150, spd_def: 120, evolves: null },
    heatran: { ability: "flash_fire", name: "Heatran", type: "Fire", type2: "Steel", baseStats: { hp: 91, atk: 90, def: 106, spd: 77 }, spa: 130, spd_def: 106, evolves: null },
    heatranmega: { ability: "flash_fire", name: "Heatran-mega", type: "Fire", type2: "Steel", baseStats: { hp: 91, atk: 120, def: 106, spd: 67 }, spa: 175, spd_def: 141, evolves: null },
    regigigas: { ability: "slow_start", name: "Regigigas", type: "Normal", baseStats: { hp: 110, atk: 160, def: 110, spd: 100 }, spa: 80, spd_def: 110, evolves: null },
    giratina: { ability: "pressure", name: "Giratina", type: "Ghost", type2: "Dragon", baseStats: { hp: 150, atk: 100, def: 120, spd: 90 }, spa: 100, spd_def: 120, evolves: null },
    giratinaorigin: { ability: "levitate", name: "Giratina-origin", type: "Ghost", type2: "Dragon", baseStats: { hp: 150, atk: 120, def: 100, spd: 90 }, spa: 120, spd_def: 100, evolves: null },
    cresselia: { ability: "levitate", name: "Cresselia", type: "Psychic", baseStats: { hp: 120, atk: 70, def: 110, spd: 85 }, spa: 75, spd_def: 120, evolves: null },
    phione: { ability: "hydration", name: "Phione", type: "Water", baseStats: { hp: 80, atk: 80, def: 80, spd: 80 }, spa: 80, spd_def: 80, evolves: null },
    manaphy: { ability: "hydration", name: "Manaphy", type: "Water", baseStats: { hp: 100, atk: 100, def: 100, spd: 100 }, spa: 100, spd_def: 100, evolves: null },
    darkrai: { ability: "bad_dreams", name: "Darkrai", type: "Dark", baseStats: { hp: 70, atk: 90, def: 90, spd: 125 }, spa: 135, spd_def: 90, evolves: null },
    darkraimega: { ability: "bad_dreams", name: "Darkrai-mega", type: "Dark", baseStats: { hp: 70, atk: 120, def: 130, spd: 85 }, spa: 165, spd_def: 130, evolves: null },
    shaymin: { ability: "natural_cure", name: "Shaymin", type: "Grass", baseStats: { hp: 100, atk: 100, def: 100, spd: 100 }, spa: 100, spd_def: 100, evolves: null },
    shayminsky: { ability: "serene_grace", name: "Shaymin-sky", type: "Grass", type2: "Flying", baseStats: { hp: 100, atk: 103, def: 75, spd: 127 }, spa: 120, spd_def: 75, evolves: null },
    arceus: { ability: "multitype", name: "Arceus", type: "Normal", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusbug: { ability: "multitype", name: "Arceus-bug", type: "Bug", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusdark: { ability: "multitype", name: "Arceus-dark", type: "Dark", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusdragon: { ability: "multitype", name: "Arceus-dragon", type: "Dragon", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceuselectric: { ability: "multitype", name: "Arceus-electric", type: "Electric", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusfairy: { ability: "multitype", name: "Arceus-fairy", type: "Fairy", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusfighting: { ability: "multitype", name: "Arceus-fighting", type: "Fighting", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusfire: { ability: "multitype", name: "Arceus-fire", type: "Fire", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusflying: { ability: "multitype", name: "Arceus-flying", type: "Flying", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusghost: { ability: "multitype", name: "Arceus-ghost", type: "Ghost", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusgrass: { ability: "multitype", name: "Arceus-grass", type: "Grass", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusground: { ability: "multitype", name: "Arceus-ground", type: "Ground", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusice: { ability: "multitype", name: "Arceus-ice", type: "Ice", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceuspoison: { ability: "multitype", name: "Arceus-poison", type: "Poison", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceuspsychic: { ability: "multitype", name: "Arceus-psychic", type: "Psychic", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceusrock: { ability: "multitype", name: "Arceus-rock", type: "Rock", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceussteel: { ability: "multitype", name: "Arceus-steel", type: "Steel", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    arceuswater: { ability: "multitype", name: "Arceus-water", type: "Water", baseStats: { hp: 120, atk: 120, def: 120, spd: 120 }, spa: 120, spd_def: 120, evolves: null },
    victini: { ability: "victory_star", name: "Victini", type: "Psychic", type2: "Fire", baseStats: { hp: 100, atk: 100, def: 100, spd: 100 }, spa: 100, spd_def: 100, evolves: null },
    snivy: { ability: "overgrow", name: "Snivy", type: "Grass", baseStats: { hp: 45, atk: 45, def: 55, spd: 63, evolves: { level: 17, into: 'servine' } }, spa: 45, spd_def: 55, evolves: { level: 17, into: "servine" } },
    servine: { ability: "overgrow", name: "Servine", type: "Grass", baseStats: { hp: 60, atk: 60, def: 75, spd: 83, evolves: { level: 36, into: 'serperior' } }, spa: 60, spd_def: 75, evolves: { level: 36, into: "serperior" } },
    serperior: { ability: "overgrow", name: "Serperior", type: "Grass", baseStats: { hp: 75, atk: 75, def: 95, spd: 113 }, spa: 75, spd_def: 95, evolves: null },
    tepig: { ability: "blaze", name: "Tepig", type: "Fire", baseStats: { hp: 65, atk: 63, def: 45, spd: 45, evolves: { level: 17, into: 'pignite' } }, spa: 45, spd_def: 45, evolves: { level: 17, into: "pignite" } },
    pignite: { ability: "blaze", name: "Pignite", type: "Fire", type2: "Fighting", baseStats: { hp: 90, atk: 93, def: 55, spd: 55, evolves: { level: 36, into: 'emboar' } }, spa: 70, spd_def: 55, evolves: { level: 36, into: "emboar" } },
    emboar: { ability: "blaze", name: "Emboar", type: "Fire", type2: "Fighting", baseStats: { hp: 110, atk: 123, def: 65, spd: 65 }, spa: 100, spd_def: 65, evolves: null },
    emboarmega: { ability: "blaze", name: "Emboar-mega", type: "Fire", type2: "Fighting", baseStats: { hp: 110, atk: 148, def: 75, spd: 75 }, spa: 110, spd_def: 110, evolves: null },
    oshawott: { ability: "torrent", name: "Oshawott", type: "Water", baseStats: { hp: 55, atk: 55, def: 45, spd: 45, evolves: { level: 17, into: 'dewott' } }, spa: 63, spd_def: 45, evolves: { level: 17, into: "dewott" } },
    dewott: { ability: "torrent", name: "Dewott", type: "Water", baseStats: { hp: 75, atk: 75, def: 60, spd: 60, evolves: { level: 36, into: 'samurott' } }, spa: 83, spd_def: 60, evolves: { level: 36, into: "samurott" } },
    samurott: { ability: "torrent", name: "Samurott", type: "Water", baseStats: { hp: 95, atk: 100, def: 85, spd: 70 }, spa: 108, spd_def: 70, evolves: null },
    samurotthisui: { ability: "torrent", name: "Samurott-hisui", type: "Water", type2: "Dark", baseStats: { hp: 90, atk: 108, def: 80, spd: 85 }, spa: 100, spd_def: 65, evolves: null },
    patrat: { ability: "run_away", name: "Patrat", type: "Normal", baseStats: { hp: 45, atk: 55, def: 39, spd: 42, evolves: { level: 20, into: 'watchog' } }, spa: 35, spd_def: 39, evolves: { level: 20, into: "watchog" } },
    watchog: { ability: "illuminate", name: "Watchog", type: "Normal", baseStats: { hp: 60, atk: 85, def: 69, spd: 77 }, spa: 60, spd_def: 69, evolves: null },
    lillipup: { ability: "vital_spirit", name: "Lillipup", type: "Normal", baseStats: { hp: 45, atk: 60, def: 45, spd: 55, evolves: { level: 16, into: 'herdier' } }, spa: 25, spd_def: 45, evolves: { level: 16, into: "herdier" } },
    herdier: { ability: "intimidate", name: "Herdier", type: "Normal", baseStats: { hp: 65, atk: 80, def: 65, spd: 60, evolves: { level: 32, into: 'stoutland' } }, spa: 35, spd_def: 65, evolves: { level: 32, into: "stoutland" } },
    stoutland: { ability: "intimidate", name: "Stoutland", type: "Normal", baseStats: { hp: 85, atk: 110, def: 90, spd: 80 }, spa: 45, spd_def: 90, evolves: null },
    purrloin: { ability: "limber", name: "Purrloin", type: "Dark", baseStats: { hp: 41, atk: 50, def: 37, spd: 66, evolves: { level: 20, into: 'liepard' } }, spa: 50, spd_def: 37, evolves: { level: 20, into: "liepard" } },
    liepard: { ability: "limber", name: "Liepard", type: "Dark", baseStats: { hp: 64, atk: 88, def: 50, spd: 106 }, spa: 88, spd_def: 50, evolves: null },
    pansage: { ability: "gluttony", name: "Pansage", type: "Grass", baseStats: { hp: 50, atk: 53, def: 48, spd: 64, evolves: { item: 'leafstone', into: 'simisage' } }, spa: 53, spd_def: 48, evolves: { level: 17, into: "simisage" } },
    simisage: { ability: "gluttony", name: "Simisage", type: "Grass", baseStats: { hp: 75, atk: 98, def: 63, spd: 101 }, spa: 98, spd_def: 63, evolves: null },
    pansear: { ability: "gluttony", name: "Pansear", type: "Fire", baseStats: { hp: 50, atk: 53, def: 48, spd: 64, evolves: { item: 'firestone', into: 'simisear' } }, spa: 53, spd_def: 48, evolves: { level: 17, into: "simisear" } },
    simisear: { ability: "gluttony", name: "Simisear", type: "Fire", baseStats: { hp: 75, atk: 98, def: 63, spd: 101 }, spa: 98, spd_def: 63, evolves: null },
    panpour: { ability: "gluttony", name: "Panpour", type: "Water", baseStats: { hp: 50, atk: 53, def: 48, spd: 64, evolves: { item: 'waterstone', into: 'simipour' } }, spa: 53, spd_def: 48, evolves: { level: 17, into: "simipour" } },
    simipour: { ability: "gluttony", name: "Simipour", type: "Water", baseStats: { hp: 75, atk: 98, def: 63, spd: 101 }, spa: 98, spd_def: 63, evolves: null },
    munna: { ability: "forewarn", name: "Munna", type: "Psychic", baseStats: { hp: 76, atk: 25, def: 45, spd: 24, evolves: { item: 'moonstone', into: 'musharna' } }, spa: 67, spd_def: 55, evolves: { level: 17, into: "musharna" } },
    musharna: { ability: "forewarn", name: "Musharna", type: "Psychic", baseStats: { hp: 116, atk: 55, def: 85, spd: 29 }, spa: 107, spd_def: 95, evolves: null },
    pidove: { ability: "big_pecks", name: "Pidove", type: "Normal", type2: "Flying", baseStats: { hp: 50, atk: 55, def: 50, spd: 43, evolves: { level: 21, into: 'tranquill' } }, spa: 36, spd_def: 30, evolves: { level: 21, into: "tranquill" } },
    tranquill: { ability: "big_pecks", name: "Tranquill", type: "Normal", type2: "Flying", baseStats: { hp: 62, atk: 77, def: 62, spd: 65, evolves: { level: 32, into: 'unfezant' } }, spa: 50, spd_def: 42, evolves: { level: 32, into: "unfezant" } },
    unfezant: { ability: "big_pecks", name: "Unfezant", type: "Normal", type2: "Flying", baseStats: { hp: 80, atk: 115, def: 80, spd: 93 }, spa: 65, spd_def: 55, evolves: null },
    blitzle: { ability: "lightning_rod", name: "Blitzle", type: "Electric", baseStats: { hp: 45, atk: 60, def: 32, spd: 76, evolves: { level: 27, into: 'zebstrika' } }, spa: 50, spd_def: 32, evolves: { level: 27, into: "zebstrika" } },
    zebstrika: { ability: "lightning_rod", name: "Zebstrika", type: "Electric", baseStats: { hp: 75, atk: 100, def: 63, spd: 116 }, spa: 80, spd_def: 63, evolves: null },
    roggenrola: { ability: "sturdy", name: "Roggenrola", type: "Rock", baseStats: { hp: 55, atk: 75, def: 85, spd: 15, evolves: { level: 25, into: 'boldore' } }, spa: 25, spd_def: 25, evolves: { level: 25, into: "boldore" } },
    boldore: { ability: "sturdy", name: "Boldore", type: "Rock", baseStats: { hp: 70, atk: 105, def: 105, spd: 20, evolves: { trade: true, into: 'gigalith' } }, spa: 50, spd_def: 40, evolves: { level: 36, into: "gigalith" } },
    gigalith: { ability: "sturdy", name: "Gigalith", type: "Rock", baseStats: { hp: 85, atk: 135, def: 130, spd: 25 }, spa: 60, spd_def: 80, evolves: null },
    woobat: { ability: "unaware", name: "Woobat", type: "Psychic", type2: "Flying", baseStats: { hp: 65, atk: 45, def: 43, spd: 72, evolves: { level: 20, into: 'swoobat' } }, spa: 55, spd_def: 43, evolves: { level: 17, into: "swoobat" } },
    swoobat: { ability: "unaware", name: "Swoobat", type: "Psychic", type2: "Flying", baseStats: { hp: 67, atk: 57, def: 55, spd: 114 }, spa: 77, spd_def: 55, evolves: null },
    drilbur: { ability: "sand_rush", name: "Drilbur", type: "Ground", baseStats: { hp: 60, atk: 85, def: 40, spd: 68, evolves: { level: 31, into: 'excadrill' } }, spa: 30, spd_def: 45, evolves: { level: 31, into: "excadrill" } },
    excadrill: { ability: "sand_rush", name: "Excadrill", type: "Ground", type2: "Steel", baseStats: { hp: 110, atk: 135, def: 60, spd: 88 }, spa: 50, spd_def: 65, evolves: null },
    excadrillmega: { ability: "sand_rush", name: "Excadrill-mega", type: "Ground", type2: "Steel", baseStats: { hp: 110, atk: 165, def: 100, spd: 103 }, spa: 65, spd_def: 65, evolves: null },
    audino: { ability: "healer", name: "Audino", type: "Normal", baseStats: { hp: 103, atk: 60, def: 86, spd: 50 }, spa: 60, spd_def: 86, evolves: null },
    audinomega: { ability: "healer", name: "Audino-mega", type: "Normal", type2: "Fairy", baseStats: { hp: 103, atk: 60, def: 126, spd: 50 }, spa: 80, spd_def: 126, evolves: null },
    timburr: { ability: "guts", name: "Timburr", type: "Fighting", baseStats: { hp: 75, atk: 80, def: 55, spd: 35, evolves: { level: 25, into: 'gurdurr' } }, spa: 25, spd_def: 35, evolves: { level: 25, into: "gurdurr" } },
    gurdurr: { ability: "guts", name: "Gurdurr", type: "Fighting", baseStats: { hp: 85, atk: 105, def: 85, spd: 40, evolves: { trade: true, into: 'conkeldurr' } }, spa: 40, spd_def: 50, evolves: { level: 36, into: "conkeldurr" } },
    conkeldurr: { ability: "guts", name: "Conkeldurr", type: "Fighting", baseStats: { hp: 105, atk: 140, def: 95, spd: 45 }, spa: 55, spd_def: 65, evolves: null },
    tympole: { ability: "swift_swim", name: "Tympole", type: "Water", baseStats: { hp: 50, atk: 50, def: 40, spd: 64, evolves: { level: 25, into: 'palpitoad' } }, spa: 50, spd_def: 40, evolves: { level: 25, into: "palpitoad" } },
    palpitoad: { ability: "swift_swim", name: "Palpitoad", type: "Water", type2: "Ground", baseStats: { hp: 75, atk: 65, def: 55, spd: 69, evolves: { level: 36, into: 'seismitoad' } }, spa: 65, spd_def: 55, evolves: { level: 36, into: "seismitoad" } },
    seismitoad: { ability: "swift_swim", name: "Seismitoad", type: "Water", type2: "Ground", baseStats: { hp: 105, atk: 95, def: 75, spd: 74 }, spa: 85, spd_def: 75, evolves: null },
    throh: { ability: "guts", name: "Throh", type: "Fighting", baseStats: { hp: 120, atk: 100, def: 85, spd: 45 }, spa: 30, spd_def: 85, evolves: null },
    sawk: { ability: "sturdy", name: "Sawk", type: "Fighting", baseStats: { hp: 75, atk: 125, def: 75, spd: 85 }, spa: 30, spd_def: 75, evolves: null },
    sewaddle: { ability: "swarm", name: "Sewaddle", type: "Bug", type2: "Grass", baseStats: { hp: 45, atk: 53, def: 70, spd: 42, evolves: { level: 20, into: 'swadloon' } }, spa: 40, spd_def: 60, evolves: { level: 20, into: "swadloon" } },
    swadloon: { ability: "leaf_guard", name: "Swadloon", type: "Bug", type2: "Grass", baseStats: { hp: 55, atk: 63, def: 90, spd: 42, evolves: { level: 20, into: 'leavanny' } }, spa: 50, spd_def: 80, evolves: { level: 36, into: "leavanny" } },
    leavanny: { ability: "swarm", name: "Leavanny", type: "Bug", type2: "Grass", baseStats: { hp: 75, atk: 103, def: 80, spd: 92 }, spa: 70, spd_def: 80, evolves: null },
    venipede: { ability: "poison_point", name: "Venipede", type: "Bug", type2: "Poison", baseStats: { hp: 30, atk: 45, def: 59, spd: 57, evolves: { level: 22, into: 'whirlipede' } }, spa: 30, spd_def: 39, evolves: { level: 22, into: "whirlipede" } },
    whirlipede: { ability: "poison_point", name: "Whirlipede", type: "Bug", type2: "Poison", baseStats: { hp: 40, atk: 55, def: 99, spd: 47, evolves: { level: 30, into: 'scolipede' } }, spa: 40, spd_def: 79, evolves: { level: 30, into: "scolipede" } },
    scolipede: { ability: "poison_point", name: "Scolipede", type: "Bug", type2: "Poison", baseStats: { hp: 60, atk: 100, def: 89, spd: 112 }, spa: 55, spd_def: 69, evolves: null },
    scolipedemega: { ability: "poison_point", name: "Scolipede-mega", type: "Bug", type2: "Poison", baseStats: { hp: 60, atk: 140, def: 149, spd: 62 }, spa: 75, spd_def: 99, evolves: null },
    cottonee: { ability: "prankster", name: "Cottonee", type: "Grass", type2: "Fairy", baseStats: { hp: 40, atk: 27, def: 60, spd: 66, evolves: { item: 'sunstone', into: 'whimsicott' } }, spa: 37, spd_def: 50, evolves: { level: 17, into: "whimsicott" } },
    whimsicott: { ability: "prankster", name: "Whimsicott", type: "Grass", type2: "Fairy", baseStats: { hp: 60, atk: 67, def: 85, spd: 116 }, spa: 77, spd_def: 75, evolves: null },
    petilil: { ability: "chlorophyll", name: "Petilil", type: "Grass", baseStats: { hp: 45, atk: 35, def: 50, spd: 30, evolves: { item: 'sunstone', into: 'lilligant' } }, spa: 70, spd_def: 50, evolves: { level: 17, into: "lilligant" } },
    lilligant: { ability: "chlorophyll", name: "Lilligant", type: "Grass", baseStats: { hp: 70, atk: 60, def: 75, spd: 90 }, spa: 110, spd_def: 75, evolves: null },
    lilliganthisui: { ability: "chlorophyll", name: "Lilligant-hisui", type: "Grass", type2: "Fighting", baseStats: { hp: 70, atk: 105, def: 75, spd: 105 }, spa: 50, spd_def: 75, evolves: null },
    basculin: { ability: "reckless", name: "Basculin", type: "Water", baseStats: { hp: 70, atk: 92, def: 65, spd: 98 }, spa: 80, spd_def: 55, evolves: null },
    basculinbluestriped: { ability: "rock_head", name: "Basculin-blue-striped", type: "Water", baseStats: { hp: 70, atk: 92, def: 65, spd: 98 }, spa: 80, spd_def: 55, evolves: null },
    basculinwhitestriped: { ability: "rattled", name: "Basculin-white-striped", type: "Water", baseStats: { hp: 70, atk: 92, def: 65, spd: 98, evolves: { level: 25, into: 'basculegion' } }, spa: 80, spd_def: 55, evolves: { level: 17, into: "basculegion" } },
    sandile: { ability: "intimidate", name: "Sandile", type: "Ground", type2: "Dark", baseStats: { hp: 50, atk: 72, def: 35, spd: 65, evolves: { level: 29, into: 'krokorok' } }, spa: 35, spd_def: 35, evolves: { level: 29, into: "krokorok" } },
    krokorok: { ability: "intimidate", name: "Krokorok", type: "Ground", type2: "Dark", baseStats: { hp: 60, atk: 82, def: 45, spd: 74, evolves: { level: 40, into: 'krookodile' } }, spa: 45, spd_def: 45, evolves: { level: 40, into: "krookodile" } },
    krookodile: { ability: "intimidate", name: "Krookodile", type: "Ground", type2: "Dark", baseStats: { hp: 95, atk: 117, def: 80, spd: 92 }, spa: 65, spd_def: 70, evolves: null },
    darumaka: { ability: "hustle", name: "Darumaka", type: "Fire", baseStats: { hp: 70, atk: 90, def: 45, spd: 50, evolves: { level: 35, into: 'darmanitan' } }, spa: 15, spd_def: 45, evolves: { level: 35, into: "darmanitan" } },
    darumakagalar: { ability: "hustle", name: "Darumaka-galar", type: "Ice", baseStats: { hp: 70, atk: 90, def: 45, spd: 50 }, spa: 15, spd_def: 45, evolves: { level: 17, into: "darmanitangalar" } },
    darmanitan: { ability: "sheer_force", name: "Darmanitan", type: "Fire", baseStats: { hp: 105, atk: 140, def: 55, spd: 95 }, spa: 30, spd_def: 55, evolves: null },
    darmanitanzen: { ability: "zen_mode", name: "Darmanitan-zen", type: "Fire", type2: "Psychic", baseStats: { hp: 105, atk: 30, def: 105, spd: 55 }, spa: 140, spd_def: 105, evolves: null },
    darmanitangalar: { ability: "gorilla_tactics", name: "Darmanitan-galar", type: "Ice", baseStats: { hp: 105, atk: 140, def: 55, spd: 95 }, spa: 30, spd_def: 55, evolves: null },
    darmanitangalarzen: { ability: "zen_mode", name: "Darmanitan-galar-zen", type: "Ice", type2: "Fire", baseStats: { hp: 105, atk: 160, def: 55, spd: 135 }, spa: 30, spd_def: 55, evolves: null },
    maractus: { ability: "water_absorb", name: "Maractus", type: "Grass", baseStats: { hp: 75, atk: 86, def: 67, spd: 60 }, spa: 106, spd_def: 67, evolves: null },
    dwebble: { ability: "sturdy", name: "Dwebble", type: "Bug", type2: "Rock", baseStats: { hp: 50, atk: 65, def: 85, spd: 55, evolves: { level: 34, into: 'crustle' } }, spa: 35, spd_def: 35, evolves: { level: 34, into: "crustle" } },
    crustle: { ability: "sturdy", name: "Crustle", type: "Bug", type2: "Rock", baseStats: { hp: 70, atk: 105, def: 125, spd: 45 }, spa: 65, spd_def: 75, evolves: null },
    scraggy: { ability: "shed_skin", name: "Scraggy", type: "Dark", type2: "Fighting", baseStats: { hp: 50, atk: 75, def: 70, spd: 48, evolves: { level: 39, into: 'scrafty' } }, spa: 35, spd_def: 70, evolves: { level: 39, into: "scrafty" } },
    scrafty: { ability: "shed_skin", name: "Scrafty", type: "Dark", type2: "Fighting", baseStats: { hp: 65, atk: 90, def: 115, spd: 58 }, spa: 45, spd_def: 115, evolves: null },
    scraftymega: { ability: "shed_skin", name: "Scrafty-mega", type: "Dark", type2: "Fighting", baseStats: { hp: 65, atk: 130, def: 135, spd: 68 }, spa: 55, spd_def: 135, evolves: null },
    sigilyph: { ability: "wonder_skin", name: "Sigilyph", type: "Psychic", type2: "Flying", baseStats: { hp: 72, atk: 58, def: 80, spd: 97 }, spa: 103, spd_def: 80, evolves: null },
    yamask: { ability: "mummy", name: "Yamask", type: "Ghost", baseStats: { hp: 38, atk: 30, def: 85, spd: 30, evolves: { level: 34, into: 'cofagrigus' } }, spa: 55, spd_def: 65, evolves: { level: 34, into: "cofagrigus" } },
    yamaskgalar: { ability: "wandering_spirit", name: "Yamask-galar", type: "Ground", type2: "Ghost", baseStats: { hp: 38, atk: 55, def: 85, spd: 30, evolves: { level: 25, into: 'runerigus' } }, spa: 30, spd_def: 65, evolves: { level: 17, into: "runerigus" } },
    cofagrigus: { ability: "mummy", name: "Cofagrigus", type: "Ghost", baseStats: { hp: 58, atk: 50, def: 145, spd: 30 }, spa: 95, spd_def: 105, evolves: null },
    tirtouga: { ability: "solid_rock", name: "Tirtouga", type: "Water", type2: "Rock", baseStats: { hp: 54, atk: 78, def: 103, spd: 22, evolves: { level: 37, into: 'carracosta' } }, spa: 53, spd_def: 45, evolves: { level: 37, into: "carracosta" } },
    carracosta: { ability: "solid_rock", name: "Carracosta", type: "Water", type2: "Rock", baseStats: { hp: 74, atk: 108, def: 133, spd: 32 }, spa: 83, spd_def: 65, evolves: null },
    archen: { ability: "defeatist", name: "Archen", type: "Rock", type2: "Flying", baseStats: { hp: 55, atk: 112, def: 45, spd: 70, evolves: { level: 37, into: 'archeops' } }, spa: 74, spd_def: 45, evolves: { level: 37, into: "archeops" } },
    archeops: { ability: "defeatist", name: "Archeops", type: "Rock", type2: "Flying", baseStats: { hp: 75, atk: 140, def: 65, spd: 110 }, spa: 112, spd_def: 65, evolves: null },
    trubbish: { ability: "stench", name: "Trubbish", type: "Poison", baseStats: { hp: 50, atk: 50, def: 62, spd: 65, evolves: { level: 36, into: 'garbodor' } }, spa: 40, spd_def: 62, evolves: { level: 36, into: "garbodor" } },
    garbodor: { ability: "stench", name: "Garbodor", type: "Poison", baseStats: { hp: 80, atk: 95, def: 82, spd: 75 }, spa: 60, spd_def: 82, evolves: null },
    garbodorgmax: { ability: "stench", name: "Garbodor-gmax", type: "Poison", baseStats: { hp: 80, atk: 95, def: 82, spd: 75 }, spa: 60, spd_def: 82, evolves: null },
    zorua: { ability: "illusion", name: "Zorua", type: "Dark", baseStats: { hp: 40, atk: 65, def: 40, spd: 65, evolves: { level: 30, into: 'zoroark' } }, spa: 80, spd_def: 40, evolves: { level: 30, into: "zoroark" } },
    zoruahisui: { ability: "illusion", name: "Zorua-hisui", type: "Normal", type2: "Ghost", baseStats: { hp: 35, atk: 60, def: 40, spd: 70 }, spa: 85, spd_def: 40, evolves: { level: 30, into: "zoroarkhisui" } },
    zoroark: { ability: "illusion", name: "Zoroark", type: "Dark", baseStats: { hp: 60, atk: 105, def: 60, spd: 105 }, spa: 120, spd_def: 60, evolves: null },
    zoroarkhisui: { ability: "illusion", name: "Zoroark-hisui", type: "Normal", type2: "Ghost", baseStats: { hp: 55, atk: 100, def: 60, spd: 110 }, spa: 125, spd_def: 60, evolves: null },
    minccino: { ability: "cute_charm", name: "Minccino", type: "Normal", baseStats: { hp: 55, atk: 50, def: 40, spd: 75, evolves: { item: 'shinystone', into: 'cinccino' } }, spa: 40, spd_def: 40, evolves: { level: 17, into: "cinccino" } },
    cinccino: { ability: "cute_charm", name: "Cinccino", type: "Normal", baseStats: { hp: 75, atk: 95, def: 60, spd: 115 }, spa: 65, spd_def: 60, evolves: null },
    gothita: { ability: "frisk", name: "Gothita", type: "Psychic", baseStats: { hp: 45, atk: 30, def: 50, spd: 45, evolves: { level: 32, into: 'gothorita' } }, spa: 55, spd_def: 65, evolves: { level: 32, into: "gothorita" } },
    gothorita: { ability: "frisk", name: "Gothorita", type: "Psychic", baseStats: { hp: 60, atk: 45, def: 70, spd: 55, evolves: { level: 41, into: 'gothitelle' } }, spa: 75, spd_def: 85, evolves: { level: 41, into: "gothitelle" } },
    gothitelle: { ability: "frisk", name: "Gothitelle", type: "Psychic", baseStats: { hp: 70, atk: 55, def: 95, spd: 65 }, spa: 95, spd_def: 110, evolves: null },
    solosis: { ability: "overcoat", name: "Solosis", type: "Psychic", baseStats: { hp: 45, atk: 30, def: 40, spd: 20, evolves: { level: 32, into: 'duosion' } }, spa: 105, spd_def: 50, evolves: { level: 32, into: "duosion" } },
    duosion: { ability: "overcoat", name: "Duosion", type: "Psychic", baseStats: { hp: 65, atk: 40, def: 50, spd: 30, evolves: { level: 41, into: 'reuniclus' } }, spa: 125, spd_def: 60, evolves: { level: 41, into: "reuniclus" } },
    reuniclus: { ability: "overcoat", name: "Reuniclus", type: "Psychic", baseStats: { hp: 110, atk: 65, def: 75, spd: 30 }, spa: 125, spd_def: 85, evolves: null },
    ducklett: { ability: "keen_eye", name: "Ducklett", type: "Water", type2: "Flying", baseStats: { hp: 62, atk: 44, def: 50, spd: 55, evolves: { level: 35, into: 'swanna' } }, spa: 44, spd_def: 50, evolves: { level: 35, into: "swanna" } },
    swanna: { ability: "keen_eye", name: "Swanna", type: "Water", type2: "Flying", baseStats: { hp: 75, atk: 87, def: 63, spd: 98 }, spa: 87, spd_def: 63, evolves: null },
    vanillite: { ability: "ice_body", name: "Vanillite", type: "Ice", baseStats: { hp: 36, atk: 50, def: 50, spd: 44, evolves: { level: 35, into: 'vanillish' } }, spa: 65, spd_def: 60, evolves: { level: 35, into: "vanillish" } },
    vanillish: { ability: "ice_body", name: "Vanillish", type: "Ice", baseStats: { hp: 51, atk: 65, def: 65, spd: 59, evolves: { level: 47, into: 'vanilluxe' } }, spa: 80, spd_def: 75, evolves: { level: 47, into: "vanilluxe" } },
    vanilluxe: { ability: "ice_body", name: "Vanilluxe", type: "Ice", baseStats: { hp: 71, atk: 95, def: 85, spd: 79 }, spa: 110, spd_def: 95, evolves: null },
    deerling: { ability: "chlorophyll", name: "Deerling", type: "Normal", type2: "Grass", baseStats: { hp: 60, atk: 60, def: 50, spd: 75, evolves: { level: 34, into: 'sawsbuck' } }, spa: 40, spd_def: 50, evolves: { level: 34, into: "sawsbuck" } },
    deerlingsummer: { ability: "chlorophyll", name: "Deerling", type: "Normal", type2: "Grass", baseStats: { hp: 60, atk: 60, def: 50, spd: 75, evolves: { level: 34, into: 'sawsbuck' } }, spa: 40, spd_def: 50, evolves: { level: 34, into: "sawsbuck" } },
    deerlingautumn: { ability: "chlorophyll", name: "Deerling", type: "Normal", type2: "Grass", baseStats: { hp: 60, atk: 60, def: 50, spd: 75, evolves: { level: 34, into: 'sawsbuck' } }, spa: 40, spd_def: 50, evolves: { level: 34, into: "sawsbuck" } },
    deerlingwinter: { ability: "chlorophyll", name: "Deerling", type: "Normal", type2: "Grass", baseStats: { hp: 60, atk: 60, def: 50, spd: 75, evolves: { level: 34, into: 'sawsbuck' } }, spa: 40, spd_def: 50, evolves: { level: 34, into: "sawsbuck" } },
    sawsbuck: { ability: "chlorophyll", name: "Sawsbuck", type: "Normal", type2: "Grass", baseStats: { hp: 80, atk: 100, def: 70, spd: 95 }, spa: 60, spd_def: 70, evolves: null },
    sawsbucksummer: { ability: "chlorophyll", name: "Sawsbuck", type: "Normal", type2: "Grass", baseStats: { hp: 80, atk: 100, def: 70, spd: 95 }, spa: 60, spd_def: 70, evolves: null },
    sawsbuckautumn: { ability: "chlorophyll", name: "Sawsbuck", type: "Normal", type2: "Grass", baseStats: { hp: 80, atk: 100, def: 70, spd: 95 }, spa: 60, spd_def: 70, evolves: null },
    sawsbuckwinter: { ability: "chlorophyll", name: "Sawsbuck", type: "Normal", type2: "Grass", baseStats: { hp: 80, atk: 100, def: 70, spd: 95 }, spa: 60, spd_def: 70, evolves: null },
    emolga: { ability: "static", name: "Emolga", type: "Electric", type2: "Flying", baseStats: { hp: 55, atk: 75, def: 60, spd: 103 }, spa: 75, spd_def: 60, evolves: null },
    karrablast: { ability: "swarm", name: "Karrablast", type: "Bug", baseStats: { hp: 50, atk: 75, def: 45, spd: 60, evolves: { trade: true, into: 'escavalier' } }, spa: 40, spd_def: 45, evolves: { level: 17, into: "escavalier" } },
    escavalier: { ability: "swarm", name: "Escavalier", type: "Bug", type2: "Steel", baseStats: { hp: 70, atk: 135, def: 105, spd: 20 }, spa: 60, spd_def: 105, evolves: null },
    foongus: { ability: "effect_spore", name: "Foongus", type: "Grass", type2: "Poison", baseStats: { hp: 69, atk: 55, def: 45, spd: 15, evolves: { level: 39, into: 'amoonguss' } }, spa: 55, spd_def: 55, evolves: { level: 39, into: "amoonguss" } },
    amoonguss: { ability: "effect_spore", name: "Amoonguss", type: "Grass", type2: "Poison", baseStats: { hp: 114, atk: 85, def: 70, spd: 30 }, spa: 85, spd_def: 80, evolves: null },
    frillish: { ability: "water_absorb", name: "Frillish", type: "Water", type2: "Ghost", baseStats: { hp: 55, atk: 40, def: 50, spd: 40, evolves: { level: 40, into: 'jellicent' } }, spa: 65, spd_def: 85, evolves: { level: 40, into: "jellicent" } },
    jellicent: { ability: "water_absorb", name: "Jellicent", type: "Water", type2: "Ghost", baseStats: { hp: 100, atk: 60, def: 70, spd: 60 }, spa: 85, spd_def: 105, evolves: null },
    alomomola: { ability: "healer", name: "Alomomola", type: "Water", baseStats: { hp: 165, atk: 75, def: 80, spd: 65 }, spa: 40, spd_def: 45, evolves: null },
    joltik: { ability: "compound_eyes", name: "Joltik", type: "Bug", type2: "Electric", baseStats: { hp: 50, atk: 47, def: 50, spd: 65, evolves: { level: 36, into: 'galvantula' } }, spa: 57, spd_def: 50, evolves: { level: 36, into: "galvantula" } },
    galvantula: { ability: "compound_eyes", name: "Galvantula", type: "Bug", type2: "Electric", baseStats: { hp: 70, atk: 77, def: 60, spd: 108 }, spa: 97, spd_def: 60, evolves: null },
    ferroseed: { ability: "iron_barbs", name: "Ferroseed", type: "Grass", type2: "Steel", baseStats: { hp: 44, atk: 50, def: 91, spd: 10, evolves: { level: 40, into: 'ferrothorn' } }, spa: 24, spd_def: 86, evolves: { level: 40, into: "ferrothorn" } },
    ferrothorn: { ability: "iron_barbs", name: "Ferrothorn", type: "Grass", type2: "Steel", baseStats: { hp: 74, atk: 94, def: 131, spd: 20 }, spa: 54, spd_def: 116, evolves: null },
    klink: { ability: "plus", name: "Klink", type: "Steel", baseStats: { hp: 40, atk: 55, def: 70, spd: 30, evolves: { level: 38, into: 'klang' } }, spa: 45, spd_def: 60, evolves: { level: 38, into: "klang" } },
    klang: { ability: "plus", name: "Klang", type: "Steel", baseStats: { hp: 60, atk: 80, def: 95, spd: 50, evolves: { level: 49, into: 'klinklang' } }, spa: 70, spd_def: 85, evolves: { level: 49, into: "klinklang" } },
    klinklang: { ability: "plus", name: "Klinklang", type: "Steel", baseStats: { hp: 60, atk: 100, def: 115, spd: 90 }, spa: 70, spd_def: 85, evolves: null },
    tynamo: { ability: "levitate", name: "Tynamo", type: "Electric", baseStats: { hp: 35, atk: 55, def: 40, spd: 60, evolves: { level: 39, into: 'eelektrik' } }, spa: 45, spd_def: 40, evolves: { level: 39, into: "eelektrik" } },
    eelektrik: { ability: "levitate", name: "Eelektrik", type: "Electric", baseStats: { hp: 65, atk: 85, def: 70, spd: 40, evolves: { item: 'thunderstone', into: 'eelektross' } }, spa: 75, spd_def: 70, evolves: { level: 36, into: "eelektross" } },
    eelektross: { ability: "levitate", name: "Eelektross", type: "Electric", baseStats: { hp: 85, atk: 115, def: 80, spd: 50 }, spa: 105, spd_def: 80, evolves: null },
    eelektrossmega: { ability: "levitate", name: "Eelektross-mega", type: "Electric", baseStats: { hp: 85, atk: 145, def: 80, spd: 80 }, spa: 135, spd_def: 90, evolves: null },
    elgyem: { ability: "telepathy", name: "Elgyem", type: "Psychic", baseStats: { hp: 55, atk: 55, def: 55, spd: 30, evolves: { level: 42, into: 'beheeyem' } }, spa: 85, spd_def: 55, evolves: { level: 42, into: "beheeyem" } },
    beheeyem: { ability: "telepathy", name: "Beheeyem", type: "Psychic", baseStats: { hp: 75, atk: 75, def: 75, spd: 40 }, spa: 125, spd_def: 95, evolves: null },
    litwick: { ability: "flash_fire", name: "Litwick", type: "Ghost", type2: "Fire", baseStats: { hp: 50, atk: 30, def: 55, spd: 20, evolves: { level: 41, into: 'lampent' } }, spa: 65, spd_def: 55, evolves: { level: 41, into: "lampent" } },
    lampent: { ability: "flash_fire", name: "Lampent", type: "Ghost", type2: "Fire", baseStats: { hp: 60, atk: 40, def: 60, spd: 55, evolves: { item: 'duskstone', into: 'chandelure' } }, spa: 95, spd_def: 60, evolves: { level: 36, into: "chandelure" } },
    chandelure: { ability: "flash_fire", name: "Chandelure", type: "Ghost", type2: "Fire", baseStats: { hp: 60, atk: 55, def: 90, spd: 80 }, spa: 145, spd_def: 90, evolves: null },
    chandeluremega: { ability: "flash_fire", name: "Chandelure-mega", type: "Ghost", type2: "Fire", baseStats: { hp: 60, atk: 75, def: 110, spd: 90 }, spa: 175, spd_def: 110, evolves: null },
    axew: { ability: "rivalry", name: "Axew", type: "Dragon", baseStats: { hp: 46, atk: 87, def: 60, spd: 57, evolves: { level: 38, into: 'fraxure' } }, spa: 30, spd_def: 40, evolves: { level: 38, into: "fraxure" } },
    fraxure: { ability: "rivalry", name: "Fraxure", type: "Dragon", baseStats: { hp: 66, atk: 117, def: 70, spd: 67, evolves: { level: 48, into: 'haxorus' } }, spa: 40, spd_def: 50, evolves: { level: 48, into: "haxorus" } },
    haxorus: { ability: "rivalry", name: "Haxorus", type: "Dragon", baseStats: { hp: 76, atk: 147, def: 90, spd: 97 }, spa: 60, spd_def: 70, evolves: null },
    cubchoo: { ability: "snow_cloak", name: "Cubchoo", type: "Ice", baseStats: { hp: 55, atk: 70, def: 40, spd: 40, evolves: { level: 37, into: 'beartic' } }, spa: 60, spd_def: 40, evolves: { level: 37, into: "beartic" } },
    beartic: { ability: "snow_cloak", name: "Beartic", type: "Ice", baseStats: { hp: 95, atk: 130, def: 80, spd: 50 }, spa: 70, spd_def: 80, evolves: null },
    cryogonal: { ability: "levitate", name: "Cryogonal", type: "Ice", baseStats: { hp: 80, atk: 50, def: 50, spd: 105 }, spa: 95, spd_def: 135, evolves: null },
    shelmet: { ability: "hydration", name: "Shelmet", type: "Bug", baseStats: { hp: 50, atk: 40, def: 85, spd: 25, evolves: { trade: true, into: 'accelgor' } }, spa: 40, spd_def: 65, evolves: { level: 17, into: "accelgor" } },
    accelgor: { ability: "hydration", name: "Accelgor", type: "Bug", baseStats: { hp: 80, atk: 70, def: 40, spd: 145 }, spa: 100, spd_def: 60, evolves: null },
    stunfisk: { ability: "static", name: "Stunfisk", type: "Ground", type2: "Electric", baseStats: { hp: 109, atk: 66, def: 84, spd: 32 }, spa: 81, spd_def: 99, evolves: null },
    stunfiskgalar: { ability: "mimicry", name: "Stunfisk-galar", type: "Ground", type2: "Steel", baseStats: { hp: 109, atk: 81, def: 99, spd: 32 }, spa: 66, spd_def: 84, evolves: null },
    mienfoo: { ability: "inner_focus", name: "Mienfoo", type: "Fighting", baseStats: { hp: 45, atk: 85, def: 50, spd: 65, evolves: { level: 50, into: 'mienshao' } }, spa: 55, spd_def: 50, evolves: { level: 50, into: "mienshao" } },
    mienshao: { ability: "inner_focus", name: "Mienshao", type: "Fighting", baseStats: { hp: 65, atk: 125, def: 60, spd: 105 }, spa: 95, spd_def: 60, evolves: null },
    druddigon: { ability: "rough_skin", name: "Druddigon", type: "Dragon", baseStats: { hp: 77, atk: 120, def: 90, spd: 48 }, spa: 60, spd_def: 90, evolves: null },
    golett: { ability: "iron_fist", name: "Golett", type: "Ground", type2: "Ghost", baseStats: { hp: 59, atk: 74, def: 50, spd: 35, evolves: { level: 43, into: 'golurk' } }, spa: 35, spd_def: 50, evolves: { level: 43, into: "golurk" } },
    golurk: { ability: "iron_fist", name: "Golurk", type: "Ground", type2: "Ghost", baseStats: { hp: 89, atk: 124, def: 80, spd: 55 }, spa: 55, spd_def: 80, evolves: null },
    golurkmega: { ability: "iron_fist", name: "Golurk-mega", type: "Ground", type2: "Ghost", baseStats: { hp: 89, atk: 159, def: 105, spd: 55 }, spa: 70, spd_def: 105, evolves: null },
    pawniard: { ability: "defiant", name: "Pawniard", type: "Dark", type2: "Steel", baseStats: { hp: 45, atk: 85, def: 70, spd: 60, evolves: { level: 52, into: 'bisharp' } }, spa: 40, spd_def: 40, evolves: { level: 52, into: "bisharp" } },
    bisharp: { ability: "defiant", name: "Bisharp", type: "Dark", type2: "Steel", baseStats: { hp: 65, atk: 125, def: 100, spd: 70, evolves: { level: 25, into: 'kingambit' } }, spa: 60, spd_def: 70, evolves: { level: 36, into: "kingambit" } },
    bouffalant: { ability: "reckless", name: "Bouffalant", type: "Normal", baseStats: { hp: 95, atk: 110, def: 95, spd: 55 }, spa: 40, spd_def: 95, evolves: null },
    rufflet: { ability: "keen_eye", name: "Rufflet", type: "Normal", type2: "Flying", baseStats: { hp: 70, atk: 83, def: 50, spd: 60, evolves: { level: 54, into: 'braviary' } }, spa: 37, spd_def: 50, evolves: { level: 54, into: "braviary" } },
    braviary: { ability: "keen_eye", name: "Braviary", type: "Normal", type2: "Flying", baseStats: { hp: 100, atk: 123, def: 75, spd: 80 }, spa: 57, spd_def: 75, evolves: null },
    braviaryhisui: { ability: "keen_eye", name: "Braviary-hisui", type: "Psychic", type2: "Flying", baseStats: { hp: 110, atk: 83, def: 70, spd: 65 }, spa: 112, spd_def: 70, evolves: null },
    vullaby: { ability: "big_pecks", name: "Vullaby", type: "Dark", type2: "Flying", baseStats: { hp: 70, atk: 55, def: 75, spd: 60, evolves: { level: 54, into: 'mandibuzz' } }, spa: 45, spd_def: 65, evolves: { level: 54, into: "mandibuzz" } },
    mandibuzz: { ability: "big_pecks", name: "Mandibuzz", type: "Dark", type2: "Flying", baseStats: { hp: 110, atk: 65, def: 105, spd: 80 }, spa: 55, spd_def: 95, evolves: null },
    heatmor: { ability: "gluttony", name: "Heatmor", type: "Fire", baseStats: { hp: 85, atk: 97, def: 66, spd: 65 }, spa: 105, spd_def: 66, evolves: null },
    durant: { ability: "swarm", name: "Durant", type: "Bug", type2: "Steel", baseStats: { hp: 58, atk: 109, def: 112, spd: 109 }, spa: 48, spd_def: 48, evolves: null },
    deino: { ability: "hustle", name: "Deino", type: "Dark", type2: "Dragon", baseStats: { hp: 52, atk: 65, def: 50, spd: 38, evolves: { level: 50, into: 'zweilous' } }, spa: 45, spd_def: 50, evolves: { level: 50, into: "zweilous" } },
    zweilous: { ability: "hustle", name: "Zweilous", type: "Dark", type2: "Dragon", baseStats: { hp: 72, atk: 85, def: 70, spd: 58, evolves: { level: 64, into: 'hydreigon' } }, spa: 65, spd_def: 70, evolves: { level: 64, into: "hydreigon" } },
    hydreigon: { ability: "levitate", name: "Hydreigon", type: "Dark", type2: "Dragon", baseStats: { hp: 92, atk: 105, def: 90, spd: 98 }, spa: 125, spd_def: 90, evolves: null },
    larvesta: { ability: "flame_body", name: "Larvesta", type: "Bug", type2: "Fire", baseStats: { hp: 55, atk: 85, def: 55, spd: 60, evolves: { level: 59, into: 'volcarona' } }, spa: 50, spd_def: 55, evolves: { level: 59, into: "volcarona" } },
    volcarona: { ability: "flame_body", name: "Volcarona", type: "Bug", type2: "Fire", baseStats: { hp: 85, atk: 60, def: 65, spd: 100 }, spa: 135, spd_def: 105, evolves: null },
    cobalion: { ability: "justified", name: "Cobalion", type: "Steel", type2: "Fighting", baseStats: { hp: 91, atk: 90, def: 129, spd: 108 }, spa: 90, spd_def: 72, evolves: null },
    terrakion: { ability: "justified", name: "Terrakion", type: "Rock", type2: "Fighting", baseStats: { hp: 91, atk: 129, def: 90, spd: 108 }, spa: 72, spd_def: 90, evolves: null },
    virizion: { ability: "justified", name: "Virizion", type: "Grass", type2: "Fighting", baseStats: { hp: 91, atk: 90, def: 72, spd: 108 }, spa: 90, spd_def: 129, evolves: null },
    tornadus: { ability: "prankster", name: "Tornadus", type: "Flying", baseStats: { hp: 79, atk: 115, def: 70, spd: 111 }, spa: 125, spd_def: 80, evolves: null },
    tornadustherian: { ability: "regenerator", name: "Tornadus-therian", type: "Flying", baseStats: { hp: 79, atk: 100, def: 80, spd: 121 }, spa: 110, spd_def: 90, evolves: null },
    thundurus: { ability: "prankster", name: "Thundurus", type: "Electric", type2: "Flying", baseStats: { hp: 79, atk: 115, def: 70, spd: 111 }, spa: 125, spd_def: 80, evolves: null },
    thundurustherian: { ability: "volt_absorb", name: "Thundurus-therian", type: "Electric", type2: "Flying", baseStats: { hp: 79, atk: 105, def: 70, spd: 101 }, spa: 145, spd_def: 80, evolves: null },
    reshiram: { ability: "turboblaze", name: "Reshiram", type: "Dragon", type2: "Fire", baseStats: { hp: 100, atk: 120, def: 100, spd: 90 }, spa: 150, spd_def: 120, evolves: null },
    zekrom: { ability: "teravolt", name: "Zekrom", type: "Dragon", type2: "Electric", baseStats: { hp: 100, atk: 150, def: 120, spd: 90 }, spa: 120, spd_def: 100, evolves: null },
    landorus: { ability: "sand_force", name: "Landorus", type: "Ground", type2: "Flying", baseStats: { hp: 89, atk: 125, def: 90, spd: 101 }, spa: 115, spd_def: 80, evolves: null },
    landorustherian: { ability: "intimidate", name: "Landorus-therian", type: "Ground", type2: "Flying", baseStats: { hp: 89, atk: 145, def: 90, spd: 91 }, spa: 105, spd_def: 80, evolves: null },
    kyurem: { ability: "pressure", name: "Kyurem", type: "Dragon", type2: "Ice", baseStats: { hp: 125, atk: 130, def: 90, spd: 95 }, spa: 130, spd_def: 90, evolves: null },
    kyuremblack: { ability: "teravolt", name: "Kyurem-black", type: "Dragon", type2: "Ice", baseStats: { hp: 125, atk: 170, def: 100, spd: 95 }, spa: 120, spd_def: 90, evolves: null },
    kyuremwhite: { ability: "turboblaze", name: "Kyurem-white", type: "Dragon", type2: "Ice", baseStats: { hp: 125, atk: 120, def: 90, spd: 95 }, spa: 170, spd_def: 100, evolves: null },
    keldeo: { ability: "justified", name: "Keldeo", type: "Water", type2: "Fighting", baseStats: { hp: 91, atk: 72, def: 90, spd: 108 }, spa: 129, spd_def: 90, evolves: null },
    keldeoresolute: { ability: "justified", name: "Keldeo-resolute", type: "Water", type2: "Fighting", baseStats: { hp: 91, atk: 72, def: 90, spd: 108 }, spa: 129, spd_def: 90, evolves: null },
    meloetta: { ability: "serene_grace", name: "Meloetta", type: "Normal", type2: "Psychic", baseStats: { hp: 100, atk: 77, def: 77, spd: 90 }, spa: 128, spd_def: 128, evolves: null },
    meloettapirouette: { ability: "serene_grace", name: "Meloetta-pirouette", type: "Normal", type2: "Fighting", baseStats: { hp: 100, atk: 128, def: 90, spd: 128 }, spa: 77, spd_def: 77, evolves: null },
    genesect: { ability: "download", name: "Genesect", type: "Bug", type2: "Steel", baseStats: { hp: 71, atk: 120, def: 95, spd: 99 }, spa: 120, spd_def: 95, evolves: null },
    genesectdouse: { ability: "download", name: "Genesect-douse", type: "Bug", type2: "Steel", baseStats: { hp: 71, atk: 120, def: 95, spd: 99 }, spa: 120, spd_def: 95, evolves: null },
    genesectshock: { ability: "download", name: "Genesect-shock", type: "Bug", type2: "Steel", baseStats: { hp: 71, atk: 120, def: 95, spd: 99 }, spa: 120, spd_def: 95, evolves: null },
    genesectburn: { ability: "download", name: "Genesect-burn", type: "Bug", type2: "Steel", baseStats: { hp: 71, atk: 120, def: 95, spd: 99 }, spa: 120, spd_def: 95, evolves: null },
    genesectchill: { ability: "download", name: "Genesect-chill", type: "Bug", type2: "Steel", baseStats: { hp: 71, atk: 120, def: 95, spd: 99 }, spa: 120, spd_def: 95, evolves: null },
};
